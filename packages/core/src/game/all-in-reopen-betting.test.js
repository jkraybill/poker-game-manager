...
describe('ALL_IN reopenBetting Bug', () => {
  ...
  it('should not reset hasActed for ALL_IN players when reopening betting', () => {
    ...
    console.log(
      `Short (ALL_IN): hasActed=${engineShort.hasActed}, state=${engineShort.state}`,
    );
    console.log(
      `Big (ACTIVE): hasActed=${engineBig.hasActed}, state=${engineBig.state}`,
    );
